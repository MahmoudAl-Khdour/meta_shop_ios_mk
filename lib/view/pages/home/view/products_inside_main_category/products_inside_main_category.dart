...
class ProductsInsideMainCategory
    extends GetWidget<ProductsInsideMainCategoryController> {
  const ProductsInsideMainCategory({Key? key}) : super(key: key);
                          ...
                          child: Obx(() {
                            ...
                            Obx(() => SizedBox(
                              ...
                              child: ListView.separated(
                                ...
                                scrollDirection: Axis.horizontal,
                                shrinkWrap: true,
                                itemCount: controller.departmentModel
                                    .value!.data!.department!.length,
                                      ...
                                      return Center(
                                        child: Button(
                                          ...
                                          onTap: () async {
                                            ...
                                            controller.selectedSubIndex.value =
                                                index;
                                            controller.clickedMainDep.value =
                                                true;

                                            await controller
                                                .getAllProductUsingCategory(
                                                    controller
                                                        .departmentModel
                                                        .value!
                                                        .data!
